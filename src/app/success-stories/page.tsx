      ...
      <div className="max-w-4xl mx-auto px-2 sm:px-4 lg:px-8">
        ...
        <div className="flex flex-col gap-12">
          {successStories.map((story, idx) => (
            <Link key={idx} href={`/success-stories`} className="block">
              <div
                className={`w-full rounded-2xl shadow-lg mx-auto p-8 flex flex-col items-center ${bgPatterns[idx % bgPatterns.length]} hover:shadow-2xl transition-shadow duration-200 cursor-pointer`}
              >
                {/* Name Circle */}
